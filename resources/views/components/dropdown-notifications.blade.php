...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    >
        ...
        @if($unreadNotifications > 0)
            <div class="absolute top-0 right-0 w-2.5 h-2.5 bg-red-500 border-2 border-white dark:border-gray-900 rounded-full"></div>
        @endif
    </button>

    <!-- Dropdown -->
    <div
        class="origin-top-right z-10 absolute top-full -mr-48 sm:mr-0 min-w-80 max-h-96 overflow-y-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1 {{ $align === 'right' ? 'right-0' : 'left-0' }}"
