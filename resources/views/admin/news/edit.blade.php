<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-4xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6">Edit Berita</h1>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6">
            <form method="POST" action="{{ route('admin.news.update', $news->slug) }}" enctype="multipart/form-data">
                ...
                {{-- Gambar Utama --}}
                <div x-data="{
                    preview: '{{ $news->image ? asset('storage/'.$news->image) : '' }}',
                    fileName: '',
                    updatePreview(e){
                    ...
                    <div x-show="preview" class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <template x-if="!fileName">
                                    <p class="text-sm font-medium text-gray-900 dark:text-white truncate">Gambar lama</p>
                                </template>
                                <p class="text-xs text-gray-500 dark:text-gray-400">Preview gambar</p>
                            </div>
