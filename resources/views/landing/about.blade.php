        ...
        <div class="py-12 sm:py-20 lg:py-24">
            <div class="text-center max-w-2xl mx-auto mb-16 sm:mb-20">
                ...
                <p class="text-[#1E1E1E] text-lg leading-relaxed mt-6">
                    Katalog UMKM ini merupakan bagian dari inisiatif elurahan Karangpoh untuk mendukung dan mempromosikan
                    pelaku Usaha Mikro, Kecil, dan Menengah (UMKM) lokal. Dengan semangat kolaborasi, platform ini bertujuan
                    memperluas jangkauan pemasaran produk unggulan warga serta membangun kemandirian ekonomi berbasis
                    komunitas.
                </p>
            </div>
