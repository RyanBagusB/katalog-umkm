    ...
    >
            ...
            <div class="col-md-6 col-lg-4">
              <div class="widget footer-widget">
                <div class="footer-info-widget">
                  ...
                  <div class="footer-info">
                    <i class="fas fa-map-marker-alt"></i> Harbour House, 60
                    Purewell, Christchurch, England
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="widget footer-widget">
                ...
                <div class="sidebar-gallery">
                  <div class="gallery-thumb">
                    <a class="popup-image" href="assets/img/gallery/gal-2-1.jpg"
                      ><img
                  ...
                  <div class="gallery-thumb">
                    <a class="popup-image" href="assets/img/gallery/gal-2-2.jpg"
                      ><img
                  ...
                  <div class="gallery-thumb">
                    <a class="popup-image" href="assets/img/gallery/gal-2-3.jpg"
                      ><img
                  ...
                  <div class="gallery-thumb">
                    <a class="popup-image" href="assets/img/gallery/gal-2-4.jpg"
                      ><img
                  ...
                  <div class="gallery-thumb">
                    <a class="popup-image" href="assets/img/gallery/gal-2-5.jpg"
                      ><img
                  ...
                  <div class="gallery-thumb">
                    <a class="popup-image" href="assets/img/gallery/gal-2-6.jpg"
                      ><img
      ...
      <div class="copyright-area" data-bg-src="assets/img/shape/footer-5-2.png">
        <div class="container">
          <div class="row justify-content-between align-items-center">
            <div class="col-lg-auto text-center text-lg-start">
              <div class="copyright">
                <p class="mb-0 link-inherit">
                  Copyright &copy; 2022 <a href="index.html">Foodano</a> - All
                  Rights Reserved by
