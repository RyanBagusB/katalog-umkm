...
<div class="">
    <div
    class="vs-hero-carousel hero-layout6"
    data-globalbgimage="assets/img/hero/hero-bg-6-1.jpg"
    data-height="810"
    data-container="1900"
    ...
    >
        ...
        width="781"
        height="534"
        src="assets/img/hero/hero-6-1.png"
        class="ls-l ls-hide-tablet ls-hide-phone ls-hide-hd"
        alt="image"
        style="
            top: 257px;
            left: 1119px;
        ...
        width="658"
        height="543"
        src="assets/img/hero/hero-6-1-1.png"
        ...
        "
        class="ls-l ls-hide-tablet ls-hide-phone"
        data-ls="offsetxin:-200; durationin:1500; delayin:400; easingin:easeOutQuint;"
        >
        100% Fresh Fruits
        </p>
        <div
        ...
        >
        <a href="shop.html" class="vs-btn style5 ls-btn"
            >Start Shopping<i class="far fa-angle-right"></i
        ></a>
        </div>
        <img
        width="658"
        ...
        width="126"
        height="151"
        src="assets/img/hero/hero-6-leaf-4.png"
        class="ls-l"
        alt="image"
        style="
            top: -300px;
        ...
        width="114"
        height="97"
        src="assets/img/hero/hero-6-leaf-1.png"
        class="ls-l"
        alt="leaf"
        style="
            top: -300px;
        ...
        width="60"
        height="66"
        src="assets/img/hero/hero-6-leaf-3.png"
        class="ls-l"
        alt="image"
        style="
            top: -300px;
        ...
        width="115"
        height="96"
        src="assets/img/hero/hero-6-leaf-2.png"
        class="ls-l"
        alt="leaf"
        style="
            top: -300px;
    ...
    >
        ...
        width="687"
        height="554"
        src="assets/img/hero/hero-6-1-2.png"
        class="ls-l ls-hide-tablet ls-hide-phone"
        alt="image"
        style="
            top: 215px;
    ...
    >
        ...
        width="639"
        height="536"
        src="assets/img/hero/hero-6-1-3.png"
        class="ls-l ls-hide-tablet ls-hide-phone"
        alt="image"
        style="
            top: 215px;
    ...
    >
        ...
        width="627"
        height="537"
        src="assets/img/hero/hero-6-1-4.png"
        class="ls-l ls-hide-tablet ls-hide-phone"
        alt="image"
        style="
            top: 215px;
    ...
    >
        ...
        width="649"
        height="537"
        src="assets/img/hero/hero-6-1-5.png"
        class="ls-l ls-hide-tablet ls-hide-phone"
        alt="image"
        style="
            top: 215px;
...
<section class="space-top">
    ...
    <div class="row vs-carousel" data-slide-show="3" id="catboxSlide4645">
        ...
        <div class="cat-box">
            ...
            <img
                src="assets/img/category/cat-1-1.png"
                alt="Category image"
            />
            </div>
        ...
        <div class="cat-box">
            <div class="cat-box__img">
            <img
                src="assets/img/category/cat-1-2.png"
                alt="Category image"
            />
            </div>
            <h3 class="cat-box__title">
        ...
        <div class="cat-box">
            <div class="cat-box__img">
            <img
                src="assets/img/category/cat-1-3.png"
                alt="Category image"
            />
            </div>
            <h3 class="cat-box__title">
        ...
        <div class="cat-box">
            <div class="cat-box__img">
            <img
                src="assets/img/category/cat-1-4.png"
                alt="Category image"
            />
            </div>
            <h3 class="cat-box__title">
    ...
    <div class="row text-center justify-content-around align-items-center">
        ...
        <button
            class="slick-arrow"
            data-slick-prev="#catboxSlide4645"
            type="button"
        >
        ...
        <div class="col-auto">
        <a href="shop.html" class="vs-btn style3"
            >Start Shopping<i class="fas fa-angle-right"></i
        ></a>
        </div>
        <div class="col-auto d-none d-sm-block">
        <button
            class="slick-arrow"
            data-slick-next="#catboxSlide4645"
            type="button"
        >
...
<section class="space">
    <div class="container">
    <div
        class="row justify-content-between align-items-center align-items-xl-start"
    >
        <div class="col-md-9 col-lg-7 col-xl-8">
        <div class="section-title">
            <span class="sub-title4">WE ARE Foodano</span>
            <h2 class="sec-title3">
        ...
        <img src="assets/img/about/ab-6-1.png" alt="About image" />
        </div>
    </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="img-box2">
            <div class="img-1">
            <img src="assets/img/about/ab-6-2.png" alt="About image" />
            <a
            ...
            ></a>
            <div class="img-2">
                <img src="assets/img/about/ab-6-3.png" alt="About image" />
            </div>
            </div>
        </div>
        </div>
...
<section
    class="sec-bg3 vs-shop-wrapper"
    data-bg-src="assets/img/shape/bg-00778.png"
>
    ...
    <div class="filter-menu2 vs-slideTab" data-asnavfor="#shopSlide8440">
        ...
        >
        <img
            src="assets/img/shape/filter-icon-bg-1-2.png"
            alt="image"
            class="bg-1"
        />
        <img
            src="assets/img/shape/filter-icon-bg-1-1.png"
            alt="image"
            class="bg-2"
        />
    ...
    >
        ...
        <div class="row gx-2px justify-content-center">
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-1.png"
                    alt="Product Image"
                    class="w-100" /></a
                ...
                <a
                    href="assets/img/shop/product-3-1.png"
                ...
                ></a>
                <a href="cart.html" class="vs-btn style4 cart-btn"
                    ><i class="fal fa-cart-plus"></i>Add To Cart</a
                >
                </div>
                ...
                <span class="price"
                    ><strong>$18.00</strong><del>$47.00</del></span
                >
                </div>
            </div>
            </div>
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-2.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-2.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-3.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag2">New</span
                ><span class="product-tag3">Sale</span>
                ...
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-3.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
                ...
                <span class="price"
                    ><strong>$78.00</strong><del>$66.00</del></span
                >
                </div>
            </div>
            </div>
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-4.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-4.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-5.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-5.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-6.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag3">Sale</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-6.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-7.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-7.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-8.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag3">Sale</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-8.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
        ...
        <div class="row gx-2px justify-content-center">
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-9.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag3">Sale</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-9.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
                ...
                <span class="price"
                    ><strong>$78.00</strong><del>$88.00</del></span
                >
                </div>
            </div>
            </div>
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-10.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag2">New</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-10.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-11.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-11.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-12.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-12.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-13.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-13.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
                ...
                <span class="price"
                    ><strong>$63.00</strong><del>$99.00</del></span
                >
                </div>
            </div>
            </div>
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-14.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag3">Sale</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-14.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-15.png"
                    alt="Product Image"
                    class="w-100" /></a
                ...
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-15.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-16.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag3">Sale</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-16.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
        ...
        <div class="row gx-2px justify-content-center">
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-17.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-17.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-18.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag3">Sale</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-18.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-19.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-19.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-20.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag3">Sale</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-20.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-21.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-21.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
                ...
                <span class="price"
                    ><strong>$39.00</strong><del>$59.00</del></span
                >
                </div>
            </div>
            </div>
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-22.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag2">New</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-22.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
                ...
                <span class="price"
                    ><strong>$19.00</strong><del>$99.00</del></span
                >
                </div>
            </div>
            </div>
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-23.png"
                    alt="Product Image"
                    class="w-100" /></a
                ...
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-23.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-24.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag3">Sale</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-24.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
        ...
        <div class="row gx-2px justify-content-center">
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-25.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-25.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-26.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag3">Sale</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-26.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
                ...
                <span class="price"
                    ><strong>$39.00</strong><del>$49.00</del></span
                >
                </div>
            </div>
            </div>
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-27.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag3">Sale</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-27.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
                ...
                <span class="price"
                    ><strong>$79.00</strong><del>$99.00</del></span
                >
                </div>
            </div>
            </div>
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-28.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-28.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-29.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag3">Sale</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-29.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
                ...
                <span class="price"
                    ><strong>$75.00</strong><del>$20.00</del></span
                >
                </div>
            </div>
            </div>
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-30.png"
                    alt="Product Image"
                    class="w-100"
                /></a>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-30.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-31.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag3">Sale</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-31.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
            ...
            <div class="vs-product-box3">
                ...
                <a href="shop-details.html"
                    ><img
                    src="assets/img/shop/product-3-32.png"
                    alt="Product Image"
                    class="w-100" /></a
                ><span class="product-tag1">Hot</span>
                </div>
                <div class="actions-btn">
                <a
                    href="assets/img/shop/product-3-32.png"
                    class="icon-btn popup-image"
                    ><i class="far fa-search"></i
                ></a>
                <a href="wishlist.html" class="icon-btn"
    ...
    <div class="bottom-btn">
        <a href="shop.html" class="vs-btn style3"
        >All Product<i class="fas fa-angle-right"></i
        ></a>
    </div>
    </div>
</section>
<section class="mb-60 mb-xl-0">
    ...
    <div class="row align-items-center">
        ...
        <div class="content-style1">
            ...
            <div>
            <a href="cart.html" class="vs-btn style4"
                ><i class="fal fa-cart-plus"></i>Add To Cart</a
            >
            </div>
        </div>
        ...
        <div class="img-box3">
            <img src="assets/img/about/ab-7-1.png" alt="About Image" />
        </div>
        </div>
        <div class="col-lg-auto order-2 order-lg-3">
        <div
            class="offer-counter counter-style1"
            data-offer-date="08/22/2024"
        >
            <span class="day">Days</span> <span class="hour">Hours</span>
            <span class="minute">Mins</span> <span class="second">Secs</span>
...
<section class="space-md-bottom">
    ...
    <div class="row gx-10">
        ...
        <div class="feature-style1">
            ...
            <img src="assets/img/icons/feature-icon-1-1.png" alt="icon" />
            </div>
        ...
        <div class="feature-style1">
            <div class="feature-icon">
            <img src="assets/img/icons/feature-icon-1-2.png" alt="icon" />
            </div>
        ...
        <div class="feature-style1">
            <div class="feature-icon">
            <img src="assets/img/icons/feature-icon-1-3.png" alt="icon" />
            </div>
        ...
        <div class="feature-style1">
            <div class="feature-icon">
            <img src="assets/img/icons/feature-icon-1-4.png" alt="icon" />
            </div>
...
<section class="position-relative space-top space-md-bottom">
    ...
    >
        ...
        <div class="package-style1">
            ...
            <img src="assets/img/package/p-1-1.jpg" alt="Package" />
            </div>
            <div
            class="package-quantity"
            data-bg-src="assets/img/shape/pack-bg.png"
            >
        ...
        <div class="package-style1">
            <div class="package-img">
            <img src="assets/img/package/p-1-2.jpg" alt="Package" />
            </div>
            <div
            class="package-quantity"
            data-bg-src="assets/img/shape/pack-bg.png"
        ...
        <div class="package-style1">
            <div class="package-img">
            <img src="assets/img/package/p-1-3.jpg" alt="Package" />
            </div>
            <div
            class="package-quantity"
            data-bg-src="assets/img/shape/pack-bg.png"
        ...
        <div class="package-style1">
            <div class="package-img">
            <img src="assets/img/package/p-1-4.jpg" alt="Package" />
            </div>
            <div
            class="package-quantity"
            data-bg-src="assets/img/shape/pack-bg.png"
...
<section class="space-bottom">
    ...
    <div class="row">
        ...
        <div class="img-box4">
            <div class="img-1">
            <img src="assets/img/about/ab-8-1.png" alt="About Image" />
            </div>
            <div class="img-2">
            <img src="assets/img/about/ab-8-2.png" alt="About Image" />
            </div>
            <div class="content">
...
<section class="space" data-bg-src="assets/img/bg/newsletter-bg-1-2.jpg">
    <div class="container">
    <div
        class="newsletter-style2"
        data-bg-src="assets/img/shape/newsletter-bg-1-1.png"
    >
        <div class="shape-1 d-none d-md-block">
        <img src="assets/img/shape/newsletter-s-008.png" alt="shape" />
        </div>
...
<section class="vs-blog-wrapper space-top space-md-bottom">
    ...
    <div class="row vs-carousel" data-slide-show="3" data-sm-slide-show="1">
        ...
        <div class="vs-blog blog-style1">
            ...
            <div class="tags"><a href="blog-details.html">Organic</a></div>
            <a href="blog-details.html" class="blog-date">Dec 22,2022</a>
            <h3 class="blog-title">
                <a href="blog-details.html"
                >From its medieval origins to the digital</a
                >
            </h3>
            <p class="blog-text">
        ...
        <div class="vs-blog blog-style1">
            ...
            <a href="blog-details.html"
                ><img
                src="assets/img/blog/blog-4-2.jpg"
                alt="Blog Image"
                class="w-100"
            /></a>
            </div>
            <div class="blog-content">
            <div class="tags"><a href="blog-details.html">Popular</a></div>
            <a href="blog-details.html" class="blog-date">Dec 18,2022</a>
            <h3 class="blog-title">
                <a href="blog-details.html"
                >Latin derived from Cicero's 1st-century</a
                >
            </h3>
            <p class="blog-text">
                Nvidunt ut labore et dolore magna aliqu accusam et justo duo
        ...
        <div class="vs-blog blog-style1">
            ...
            <div class="blog-content">
            <div class="tags"><a href="blog-details.html">Fresh</a></div>
            <a href="blog-details.html" class="blog-date">Jan 21,2022</a>
            <h3 class="blog-title">
                <a href="blog-details.html"
                >Creation timelines for the standard lorem</a
                >
            </h3>
            <p class="blog-text">
                Nvidunt ut labore et dolore magna aliqu accusam et justo duo
        ...
        <div class="vs-blog blog-style1">
            ...
            <div class="blog-content">
            <div class="tags"><a href="blog-details.html">Natural</a></div>
            <a href="blog-details.html" class="blog-date">Mar 1,2022</a>
            <h3 class="blog-title">
                <a href="blog-details.html"
                >Lorem ipsum was purposefully designed</a
                >
            </h3>
            <p class="blog-text">
                Nvidunt ut labore et dolore magna aliqu accusam et justo duo
...
<div class="space-bottom">
    ...
    <div class="row gx-0 gy-4 justify-content-center text-center">
        ...
        <img src="assets/img/brand/logo-1-1.png" alt="Barnad Image" />
        </div>
        <div class="col-6 col-sm-4 col-md-4 col-lg-3 brand-style1">
        <img src="assets/img/brand/logo-1-2.png" alt="Barnad Image" />
        </div>
        <div class="col-6 col-sm-4 col-md-4 col-lg-3 brand-style1">
        <img src="assets/img/brand/logo-1-3.png" alt="Barnad Image" />
        </div>
        <div class="col-6 col-sm-4 col-md-4 col-lg-3 brand-style1">
        <img src="assets/img/brand/logo-1-4.png" alt="Barnad Image" />
        </div>
    </div>
    </div>
</div>
<section class="banner-wrap1">
    ...
    <div class="row gy-30">
        ...
        <div
            class="banner-style1"
            data-bg-src="assets/img/banner/banner-1-1.jpg"
        >
        ...
        <div
            class="banner-style1"
            data-bg-src="assets/img/banner/banner-1-2.jpg"
        >
            <div class="banner-content">
            <span class="banner-subtitle">End of season -50%</span>
        ...
        <div
            class="banner-style1"
            data-bg-src="assets/img/banner/banner-1-3.jpg"
        >
            <div class="banner-content">
            <span class="banner-subtitle">End of season -50%</span>
